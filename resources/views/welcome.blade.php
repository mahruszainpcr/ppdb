...
<body>
    ...
    <header class="hero" id="home">
        <div class="nav">
            <div class="container">
                <div class="nav-inner">
                    <a class="brand" href="#home" aria-label="Ma’had Darussalam Al-Islami">
                        <div class="logo"><img src="https://mahaddarussalampalas.ponpes.id/logo.png" alt="">
                        </div>
                        <div>
            ...
            <div class="footer-grid">
                <div class="footer-about">
                    <div class="brand" style="margin-bottom:10px">
                        <div class="logo"><img src="https://mahaddarussalampalas.ponpes.id/logo.png"
                                alt=""></div>
                        <div>
                    ...
                    <p style="margin-top:10px">
                        ...
                        NPSN 70034877 • NSPP 510014710047
                    </p>
                </div>
